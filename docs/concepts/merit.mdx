...
No manual setup required - Merit resolves dependencies automatically. See [Resource](/docs/concepts/resource) and [Metric](/docs/concepts/metric) for details.
...
See [Case](/docs/concepts/case) for typed references and validation.
