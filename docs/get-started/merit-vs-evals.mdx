...
|------------|-------|-------|-------|
| Native Python syntax | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
| Explicit test logic | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
| Cases in datasets | <Badge icon="circle-check" color="green">Yes</Badge> | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
| Metrics aggregations | <Badge icon="circle-check" color="green">Yes</Badge> | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
| Determinism checks | <Badge icon="clock" color="orange">Partial</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
| LLM-as-a-Judge | <Badge icon="clock" color="orange">Partial</Badge> | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |
...
| Historical data | <Badge icon="clock" color="orange">Partial</Badge> | <Badge icon="ban" color="red">No</Badge> | <Badge icon="circle-check" color="green">Yes</Badge> |

### AI Predicates: Assert meaning, not strings

Merit's [AI predicates](/concepts/semantic-predicates) let you assert on complex properties:
